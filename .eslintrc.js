...
module.exports = {
    ...
    rules: {
        ...
        'comma-dangle': ["warn", "always-multiline"], // 禁用拖尾逗号 ['a': 1, 'b': 3],3后面不能有逗号
        'comma-spacing': ["warn", {
            "before": false,
            "after": true
        }], // 强制在逗号周围使用空格 a = 1, b = 3; 前面不要有空格，后面有空格
        'computed-property-spacing': ["error", "never"], // 禁止在计算属性中使用空格 a['key']
        'curly': "warn", // 要求遵循大括号约定 if () {} 必须要有{}
        'eqeqeq': "warn", // 要求使用 === 和 !==
        'indent': ["warn", 4, {
            "SwitchCase": 1
        }],
        ...
        'semi': ["warn", "always"], // 要求句末添加分号
        'semi-spacing': ["warn", {
            "before": false,
            "after": true
        }], // 强制分号周围的空格
        'space-before-blocks': ["error", "always"], // 要求语句块之前的空格
        'space-before-function-paren': ["warn", "never"], // 要求函数圆括号之前有一个空格
