    ...
    <el-container>
        <el-header class="bierinc-header">
            <el-row class="bierinc-header-left">
                ...
                <el-col :span="8"
                    ...
                    <!-- <div class="bierinc-type">Amazon</div> -->
                    <el-dropdown class="bierinc-lanuage-drop"
                                 @command="handleCommand">
                        <span class="el-dropdown-link bierinc-type">
                            <span>{{platform|showPlatformType}}</span>
                        </span>
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item command="amazon">Amazon</el-dropdown-item>
                            <el-dropdown-item command="tiktokv">抖音</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </el-col>
            </el-row>
        ...
        <el-container class="bierinc-main-container">
            <el-aside width="200px"
                      class="bierinc-main-container-aside">
                <ul class="bierinc-main-container-aside-menu">
                    <router-link tag="li"
                                 class="bierinc-main-container-aside-menu-li"
                                 :to="{ name: platform==='amazon'?'home':'tikhome' }">用户管理</router-link>
                    <router-link tag="li"
                                 class="bierinc-main-container-aside-menu-li"
                                 :to="{ name: platform==='amazon'?'bulletin':'tikbulletin' }">公告管理</router-link>
                    <router-link tag="li"
                                 class="bierinc-main-container-aside-menu-li"
                                 :to="{ name: platform==='amazon'?'feedback':'tikfeedback' }">反馈管理</router-link>
                </ul>
            </el-aside>
    ...
    methods: {
        handleCommand(command) {
            switch (command) {
                ...
                case 'tiktokv': {
                    this.platform = command;
                    this.$router.push({name: 'tikindex'})
                    this.handleInfo('setPlatformType', command)
                    break;
                }
                default:
